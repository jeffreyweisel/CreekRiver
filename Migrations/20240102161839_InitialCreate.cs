    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "john@example.com", "John", "Lennon" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://lh3.googleusercontent.com/p/AF1QipOc5jWvSu-c5HivEEko92dSYNGrgt6h530st5PR=s680-w680-h510", "Elm Hill RV Resort" },
                    { 3, 3, "https://lh3.googleusercontent.com/p/AF1QipNZIU7CRgM0dPCGDIyuER2MhGVIItZSia1_JMSm=s680-w680-h510", "Howlin' Hill" },
                    { 4, 4, "https://lh3.googleusercontent.com/p/AF1QipPD7s8DPh_eDhLVFdUyU-jNLOyt4kMjdgw_VDyn=s680-w680-h510", "Seven Points Campground" },
                    { 5, 1, "https://lh3.googleusercontent.com/p/AF1QipN8QNJu1DsK_QvquRMhySRc3M3kF22gqW9-u24D=s680-w680-h510", "Poole Knobs Campground" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2024, 1, 4, 10, 18, 39, 312, DateTimeKind.Local).AddTicks(1240), new DateTime(2024, 1, 11, 10, 18, 39, 312, DateTimeKind.Local).AddTicks(1280), 1 });
